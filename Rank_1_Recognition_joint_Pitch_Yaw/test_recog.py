...
def test_recog(model_type):
    ...
    Rank_1_dir = "/home/moktari/Moktari/2022/facenet-pytorch-master/Facenet_Finetune_Pose_aware_Attention/M2FPA/Rank_1_Recognition_joint_Pitch_Yaw/Pitch_30/Pitch_neg_30"
    probe_file = '/home/moktari/Moktari/2022/facenet-pytorch-master/Facenet_Finetune_Pose_aware_Attention/M2FPA/Rank_1_Recognition_joint_Pitch_Yaw/Pitch_30/Pitch_neg_30/probe_45_list.txt'
    probe_data = load_meta_data(probe_file, 'probe_45')
    # gallery_file = os.path.join(split_protocol_dir, 'search_gallery_{}.csv'.format(split))
    gallery_file = '/home/moktari/Moktari/2022/facenet-pytorch-master/Facenet_Finetune_Pose_aware_Attention/M2FPA/Rank_1_Recognition_joint_Pitch_Yaw/Pitch_30/Pitch_neg_30/Gallery_list.txt'
    gallery_data = load_meta_data(gallery_file, 'Gallery')
    # load extract feat
    feats = dict()
    # feat_dim = 0
    # split_img_dir = os.path.join(align_img_dir, 'split{}'.format(split))
    for img_type in ['Gallery', 'probe_45']:
